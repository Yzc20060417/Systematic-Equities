...
## 1. Returns predictions indexed by (date,ticker) for all test dates where training is possible given a certain model
...
## 2. Fold Dates for train-test split
...
## 4. Build X and y and group sizes by date in row order
